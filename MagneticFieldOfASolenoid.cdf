...
NotebookDataLength[     76355,       1510]
NotebookOptionsPosition[     49958,        938]
NotebookOutlinePosition[     76215,       1499]
CellTagsIndexPosition[     76104,       1493]
WindowTitle->Magnetic Field of a Solenoid
WindowFrame->Normal*)
...
Cell["Magnetic Field of a Solenoid", "DemoTitle"],
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`n$$ = 2, Typeset`show$$ = True, 
    ...
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n$$], 1, "turns"}, {1, 2, 3, 4, 5}}}, 
    Typeset`size$$ = {400., {198., 202.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`n$263105$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`n$$ = 1}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$263105$$, 0]}, 
      "OtherVariables" :> {
      ...
      DensityPlot[
       2 (Sum[-((-1)^$CellContext`i (($CellContext`x - \
$CellContext`i)/((($CellContext`x - $CellContext`i)^2 + ($CellContext`y + \
(-1)^$CellContext`i)^2)^Rational[1, 2])^2)), {$CellContext`i, 1, 
               2 $CellContext`n$$}]^2 + 
           Sum[-((-(-1)^$CellContext`i) (($CellContext`y + \
(-1)^$CellContext`i)/((($CellContext`x - $CellContext`i)^2 + ($CellContext`y + \
(-1)^$CellContext`i)^2)^Rational[1, 2])^2)), {$CellContext`i, 1, 
               2 $CellContext`n$$}]^2)^Rational[1, 2] + 
        Cos[20 Sum[-((-1)^$CellContext`i/(($CellContext`x - $CellContext`i)^2 + \
($CellContext`y + (-1)^$CellContext`i)^2)^Rational[1, 2]), {$CellContext`i, 1,
              2 $CellContext`n$$}]] + 
        1, {$CellContext`x, -2, 13}, {$CellContext`y, -4, 4}, Mesh -> False, 
        Frame -> False, PlotRange -> {0, 10}, PlotPoints -> {50, 50}, 
        ImageSize -> {400, Automatic}, 
        ColorFunction -> (ColorData[
         "ThermometerColors"][(0.2 #) $CellContext`n$$]& )], 
      "Specifications" :> {{{$CellContext`n$$, 1, "turns"}, {1, 2, 3, 4, 5}}},
       "Options" :> {
       SynchronousInitialization -> False, SynchronousUpdating -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{445., {241., 246.}},
...
Cell["\<\
A solenoid is a helical coil wound around a cylinder. When a current runs \
through the coil, a magnetic field is created. The strength of the magnetic \
field is proportional to the number of turns. This Demonstration approximates \
the field using the Biot\[Dash]Savart law by way of superposition point \
...
Cell[TextData[{
 ButtonBox["Biot-Savart Law",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Biot-SavartLaw.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/Biot-SavartLaw.html"],
 " (",
...
Cell[TextData[{
 ButtonBox["Magnetic Field",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/MagneticField.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/MagneticField.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Solenoid",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Solenoid.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/Solenoid.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
MagneticFieldOfASolenoid&version=0005"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/MagneticFieldOfASolenoid/\
MagneticFieldOfASolenoid-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Magnetic Field of a Solenoid",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/MagneticFieldOfASolenoid/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/MagneticFieldOfASolenoid/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/MagneticFieldOfASolenoid/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/MagneticFieldOfASolenoid/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/MagneticFieldOfASolenoid/"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[38665, 664, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[38926, 673, 2555, 55, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[49136, 913, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 75818, 1482},
 {"Copyright", 76013, 1487}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[35660, 602, 2611, 51, 70, "Output",
 CellID->1260277355],
Cell[38274, 655, 388, 7, 70, "ManipulateCaption",
 CellID->1260421650],
Cell[38665, 664, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[38926, 673, 2555, 55, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41484, 730, 44, 0, 70, "RelatedLinksSection"],
Cell[41531, 732, 500, 15, 70, "RelatedLinks",
 CellID->571995016],
Cell[42034, 749, 497, 15, 70, "RelatedLinks",
 CellID->501555511],
Cell[42534, 766, 482, 15, 70, "RelatedLinks",
 CellID->1176725445],
Cell[43019, 783, 4811, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[47833, 874, 45, 0, 70, "CitationSection"],
Cell[47881, 876, 330, 10, 70, "Author"],
Cell[48214, 888, 919, 23, 70, "Citations"],
Cell[49136, 913, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature VQqN5wpFUm4XJxmFGcOm9toG *)
